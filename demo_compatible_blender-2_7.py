...
if __name__ == '__main__':
    ...
    parser.add_argument('--anno_idx', type=int, default=0,
                        help='index of annotation')
    parser.add_argument('--output_path', type=str, default='./demo.png',
                        help='output image path')
    parser.add_argument('--model_base_path', type=str, default='/data/3dPrinter/0_Dataset_Ori/3_AutoSDF_Datasets/pix3d',
    ...
    data_list = json.load(open(f'{args.model_base_path}/pix3d.json'))
    
    # Update the model path to be absolute
    data_list[args.anno_idx]['model'] = f"{args.model_base_path}/{data_list[args.anno_idx]['model']}"
